...
if(isset($_GET['add'])){
	...
	<form action="products.php?add=1" method="POST" enctype="multipart/form-data">
		...
		<div class="form-group col-md-3">
			...
			<input type="text" id="price" name="list_price" class="form-control" value="<?=((isset($_POST['list_price']))?sanitize($_POST['list_price']):''); ?>">
		</div>
		<div class="form-group col-md-3">
...
<table class="table table-bordered table-condensed table-striped">
	<thead><th></th><th>Product</th><th>Price</th><th>Categories</th><th>Feature</th><th>Sold</th></thead>
	<tbody>
		...
		?>
			<tr>
				<td>
					<a href="products.php?edit=<?=$product['id'];?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-pencil"></a>
					<a href="products.php?delete=<?=$product['id'];?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-remove"></a>
				</td>
				<td><?=$product['title'];?>	</td>
