	...
	<div class="row">
		...
		<?php else: ?>
			...
			<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModalLabel">
				<div dlass="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-tittle" id="checkoutModalLabel">Shipping Address</h4>
						</div>
						...
						<div class="row">
							<form action="thankYou.php" method="post" id="payment-form">
								...
								<input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count > 1)?'s':'').' from Mazz Guitars.';?>">
...
function check_address(){
	...
	$.ajax({
		url : '/onlineShop/admin/parsers/check_address.php',
		method : 'POST',
		data : data,
	...
	function stripeResponseHandler(status, response){
		...
		if (response.error){
			...
			//response the token into the form so it geht submitted to the server
