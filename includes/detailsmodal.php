...
<!-- Details Light Box Modal -->
	<?php ob_start(); ?>
	<div class="modal fade details-1" id="details-modal" tabindex="-1" aria-labelledby="#details-1">
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-header">
				...
				<div class="modal-footer">
					...
					<button class="btn brn-warning" onclick="add_to_cart();return false;"><span class="glyphicon glyphicon-shopping-cart"></span>Add to cart</button>
				</div>
			</div>
		</div>
	</div>
